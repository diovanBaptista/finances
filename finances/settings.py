...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'finances.herokuapp.com',
    'finances.dokku.outboxsistemas.com',
]
...
if USE_AWS:
    ...
    AWS_STORAGE_BUCKET_NAME = 'django-finances'
    ...
    DEFAULT_FILE_STORAGE = 'finances.storage_backends.PublicMediaStorage'
